...
final class Version20220403155109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE search_result (id INT AUTO_INCREMENT NOT NULL, search_request_id INT DEFAULT NULL, parser_name VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, age INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_CA88AE0C9AC8886F (search_request_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
